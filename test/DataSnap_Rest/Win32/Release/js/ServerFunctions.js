...
function TdmServerMethods(connectionInfo)
{
  this.executor = new ServerFunctionExecutor("TdmServerMethods",connectionInfo);
   ...
   * @param Sender [in] - Type on server: TObject
   */
  this.DataModuleDestroy = function(Sender) {
    this.executor.executeMethod('"DataModuleDestroy"', "POST", [Sender], arguments[1], false, arguments[2], arguments[3]);
  };
  ...
  /*
   * @param aLogin [in] - Type on server: string
   * @return result - Type on server: TDataSet
   */
  this.GetUsuario = function(aLogin) {
    var returnObject = this.executor.executeMethod('GetUsuario', "GET", [aLogin], arguments[1], true, arguments[2], arguments[3]);
    if (arguments[1] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
        resultObject.aLogin = aLogin;
        resultObject.result = resultArray[0];
        if (returnObject.cacheId != null && returnObject.cmdIndex != null) {
          resultObject._cacheId = returnObject.cacheId;
          resultObject._cmdIndex = returnObject.cmdIndex;
  ...
  this.GetUsuario_URL = function(aLogin) {
    return this.executor.getMethodURL("GetUsuario", "GET", [aLogin], arguments[1])[0];
  };
}
...
var JSProxyClassList = {
  ...
  "TdmServerMethods": ["DataModuleCreate","DataModuleDestroy","EchoString","ReverseString","GetUsuario"]
};
