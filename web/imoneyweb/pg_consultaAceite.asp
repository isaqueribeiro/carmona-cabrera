...
sNomedaPagina="Lançamentos Cadastrados"
...
<HTML>
<HEAD>
<TITLE>Consultar Lan&ccedil;amentos</TITLE>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
   <tr>
     ...
     <td width="11%" background="back2.gif"><a class="LinskMenuPagina" href="pg_operacoesAceite.asp?ope=novo">Novo Lançamento</a></td>
    ...
    <td width="697"><form name="form1" method="post" action="p_filtroAceiteresp.asp" class="form">
      <table width="519" border="0" cellpadding="0" cellspacing="0" class="Borda_tabela">
        ...
        <tr>
          ...
          <td width="99"><label>
            <input name="chkInclusao" type="checkbox" id="chkInclusao" value="1" checked>
            <span class="texto_pagina">Inclus&atilde;o</span></label></td>
          <td width="70" rowspan="2"><label>
            <div align="center">
              <input name="button" type="image" class="botao_enviar" id="button" title="Pesquisar" value="Pesquisar" src="imagens/pesqpeq.png" alt="Pesquisar">
               &nbsp;<a href="p_filtroAceiteresp.asp?acao=limpar"><img src="imagens/iconLimpar.png" width="16" title="Limpar pesquisa" height="16" border="0"></a></div>

          </label></td>
        </tr>
        <tr>
          <td class="texto_pagina">Nome:</td>
          <td><INPUT name=txtnome type=text class=texto_pagina id="txtnome" value=""></td>
          <td class="texto_pagina">&nbsp;</td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          </tr>
        <%if session("gS_nmCriterio")<>"" then %>
        <tr>
          <td colspan="6" class="texto_pagina">Crit&eacute;rio de Busca:<br>
                <strong><%=session("gS_nmCriterio")%></strong></td>
          </tr>
        <%end if%>
      </table>
        </form>
...
if session("gS_CriterioMovimento")="" then sComplemento= " and mny_movimento.mov_codigo=0" else sComplemento=session("gS_CriterioMovimento")
...
<SELECT name=campo_busca class=texto_pagina>
  <OPTION value="" selected>Registros</OPTION>
   ...
   <OPTION value="pes_razao_social" <% If Trim(Request("campo_busca")) = Trim("pes_razao_social") Then : Response.Write "selected" : End If %>>razao_social</OPTION>
   <OPTION value="mov_data_vencto" <% If Trim(Request("campo_busca")) = Trim("mov_data_vencto") Then : Response.Write "selected" : End If %>>Vencimento</OPTION>
