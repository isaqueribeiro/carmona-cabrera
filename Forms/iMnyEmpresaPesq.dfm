object FrmEmpresaPesq: TFrmEmpresaPesq
  Left = 477
  Top = 208
  Width = 661
  Height = 451
    ...
    object TbShtPrincipal: TcxTabSheet
      ...
      object DbGrd: TcxGrid
        ...
        object DbGridDBTblVw: TcxGridDBTableView
          ...
          object DbGridDBTblVwemp_codigo: TcxGridDBColumn
            Caption = 'C'#243'digo'
            DataBinding.FieldName = 'emp_codigo'
          end
          object DbGridDBTblVwemp_razao_social: TcxGridDBColumn
            Caption = 'Raz'#227'o Social'
            DataBinding.FieldName = 'emp_razao_social'
          end
          object DbGridDBTblVwemp_fantasia: TcxGridDBColumn
            Caption = 'Fantasia'
            DataBinding.FieldName = 'emp_fantasia'
          end
          object DbGridDBTblVwemp_cnpj: TcxGridDBColumn
            Caption = 'CNPJ'
            DataBinding.FieldName = 'emp_cnpj'
          end
        end
  ...
  object QryMaster: TSQLQuery
    ...
    SQL.Strings = (
      ...
      '  `sys_empresa` a'
      'where'
      '  a.`emp_fantasia` like :nome')
    SQLConnection = FrmLogin.conWebMaster
    Left = 336
    Top = 240
    object QryMasteremp_codigo: TSmallintField
      FieldName = 'emp_codigo'
      Required = True
    end
    object QryMasteremp_razao_social: TStringField
      FieldName = 'emp_razao_social'
      Size = 60
    end
    object QryMasteremp_fantasia: TStringField
      FieldName = 'emp_fantasia'
      Size = 60
    end
    object QryMasteremp_cnpj: TStringField
      FieldName = 'emp_cnpj'
    end
    object QryMasteremp_imagem: TBlobField
      FieldName = 'emp_imagem'
      Size = 1
    end
    object QryMasteremp_end_logra: TStringField
      FieldName = 'emp_end_logra'
      Size = 60
    end
    object QryMasteremp_end_cidade: TStringField
      FieldName = 'emp_end_cidade'
      Size = 60
    end
    object QryMasteremp_end_bairro: TStringField
      FieldName = 'emp_end_bairro'
      Size = 60
    end
    object QryMasteremp_end_cep: TStringField
      FieldName = 'emp_end_cep'
      Size = 8
    end
    object QryMasteremp_end_uf: TStringField
      FieldName = 'emp_end_uf'
      Size = 2
    end
    object QryMasteremp_end_fone: TStringField
      FieldName = 'emp_end_fone'
    end
    object QryMasteremp_ftp: TStringField
      FieldName = 'emp_ftp'
      Size = 200
    end
    object QryMasteremp_site: TStringField
      FieldName = 'emp_site'
      Size = 200
    end
    object QryMasteremp_email: TStringField
      FieldName = 'emp_email'
      Size = 60
    end
    object QryMasteremp_inc: TStringField
      FieldName = 'emp_inc'
      Size = 60
    end
    object QryMasteremp_alt: TStringField
      FieldName = 'emp_alt'
      Size = 60
    end
    object QryMasteremp_aceite: TSmallintField
  ...
  object ClntDtStMaster: TClientDataSet
    ...
    Left = 336
    Top = 272
    object ClntDtStMasteremp_codigo: TSmallintField
      FieldName = 'emp_codigo'
      Required = True
    end
    object ClntDtStMasteremp_razao_social: TStringField
      FieldName = 'emp_razao_social'
      Size = 60
    end
    object ClntDtStMasteremp_fantasia: TStringField
      FieldName = 'emp_fantasia'
      Size = 60
    end
    object ClntDtStMasteremp_cnpj: TStringField
      FieldName = 'emp_cnpj'
    end
    object ClntDtStMasteremp_imagem: TBlobField
      FieldName = 'emp_imagem'
      Size = 1
    end
    object ClntDtStMasteremp_end_logra: TStringField
      FieldName = 'emp_end_logra'
      Size = 60
    end
    object ClntDtStMasteremp_end_cidade: TStringField
      FieldName = 'emp_end_cidade'
      Size = 60
    end
    object ClntDtStMasteremp_end_bairro: TStringField
      FieldName = 'emp_end_bairro'
      Size = 60
    end
    object ClntDtStMasteremp_end_cep: TStringField
      FieldName = 'emp_end_cep'
      Size = 8
    end
    object ClntDtStMasteremp_end_uf: TStringField
      FieldName = 'emp_end_uf'
      Size = 2
    end
    object ClntDtStMasteremp_end_fone: TStringField
      FieldName = 'emp_end_fone'
    end
    object ClntDtStMasteremp_ftp: TStringField
      FieldName = 'emp_ftp'
      Size = 200
    end
    object ClntDtStMasteremp_site: TStringField
      FieldName = 'emp_site'
      Size = 200
    end
    object ClntDtStMasteremp_email: TStringField
      FieldName = 'emp_email'
      Size = 60
    end
    object ClntDtStMasteremp_inc: TStringField
      FieldName = 'emp_inc'
      Size = 60
    end
    object ClntDtStMasteremp_alt: TStringField
      FieldName = 'emp_alt'
      Size = 60
    end
    object ClntDtStMasteremp_aceite: TSmallintField
      FieldName = 'emp_aceite'
    end
  end
  object QryMax: TSQLQuery
    ...
    SQL.Strings = (
      'select'
      '  MAX(coalesce(a.`emp_codigo`,0)) as seq'
      'from'
      '  `sys_empresa` a')
    SQLConnection = FrmLogin.conWebMaster
    Left = 368
