  ...
  object PgCtrlMain: TcxPageControl
    ...
    object TbShtPrincipal: TcxTabSheet
      ...
      object DbEdtCodigo: TcxDBTextEdit
        Left = 64
        Top = 16
        DataBinding.DataField = 'emp_codigo'
        DataBinding.DataSource = FrmEmpresaPesq.DtSMaster
        Style.Color = 8454143
        TabOrder = 0
        Width = 121
      end
      object DbEdtRazao: TcxDBTextEdit
        Left = 64
        Top = 40
        DataBinding.DataField = 'emp_razao_social'
        DataBinding.DataSource = FrmEmpresaPesq.DtSMaster
        TabOrder = 1
        Width = 465
      end
      ...
      object DbEdFantasia: TcxDBTextEdit
        Left = 64
        Top = 64
        DataBinding.DataField = 'emp_fantasia'
        DataBinding.DataSource = FrmEmpresaPesq.DtSMaster
        TabOrder = 2
        Width = 465
      end
      object DbEdtCNPJ: TcxDBTextEdit
        Left = 64
        Top = 88
        DataBinding.DataField = 'emp_cnpj'
        DataBinding.DataSource = FrmEmpresaPesq.DtSMaster
        TabOrder = 3
        Width = 154
      end
      object DbEdtEnd: TcxDBTextEdit
        Left = 64
        Top = 112
        DataBinding.DataField = 'emp_end_logra'
        DataBinding.DataSource = FrmEmpresaPesq.DtSMaster
        TabOrder = 4
        Width = 401
      end
      ...
      object DbEdtCidade: TcxDBTextEdit
        Left = 64
        Top = 136
        DataBinding.DataField = 'emp_end_cidade'
        DataBinding.DataSource = FrmEmpresaPesq.DtSMaster
        TabOrder = 6
        Width = 114
      end
      object DbEdtBairro: TcxDBTextEdit
        Left = 223
        Top = 136
        DataBinding.DataField = 'emp_end_bairro'
        DataBinding.DataSource = FrmEmpresaPesq.DtSMaster
        TabOrder = 7
        Width = 122
      end
      ...
      object DbEdtCEP: TcxDBTextEdit
        Left = 392
        Top = 136
        DataBinding.DataField = 'emp_end_cep'
        DataBinding.DataSource = FrmEmpresaPesq.DtSMaster
        TabOrder = 8
        Width = 137
      end
      ...
      object DbEdtUF: TcxDBTextEdit
        Left = 496
        Top = 112
        DataBinding.DataField = 'emp_end_uf'
        DataBinding.DataSource = FrmEmpresaPesq.DtSMaster
        TabOrder = 5
        Width = 33
      end
      ...
      object DbEdtFTP: TcxDBTextEdit
        Left = 64
        Top = 160
        DataBinding.DataField = 'emp_ftp'
        DataBinding.DataSource = FrmEmpresaPesq.DtSMaster
        TabOrder = 9
        Width = 217
      end
      ...
      object DbEdtSite: TcxDBTextEdit
        Left = 320
        Top = 160
        DataBinding.DataField = 'emp_site'
        DataBinding.DataSource = FrmEmpresaPesq.DtSMaster
        TabOrder = 10
        Width = 210
      end
      ...
      object DbEdtEmail: TcxDBTextEdit
        Left = 64
        Top = 184
        DataBinding.DataField = 'emp_email'
        DataBinding.DataSource = FrmEmpresaPesq.DtSMaster
        TabOrder = 11
        Width = 465
      end
      object DBEdtImagem: TcxLabel
        Left = 8
        Top = 208
        Caption = 'Imagem:'
        Transparent = True
      end
      object DbImgLogo: TcxDBImage
        Left = 64
        Top = 212
      ...
      object DbLkpCmbBxAceite: TcxDBImageComboBox
        Left = 200
        Top = 208
        DataBinding.DataField = 'emp_aceite'
        DataBinding.DataSource = FrmEmpresaPesq.DtSMaster
        Properties.Items = <
          item
            Description = 'No Cadastro'
            ImageIndex = 0
            Value = 0
          end
          item
            Description = 'Somente Autorizado'
            Value = 1
          end>
        TabOrder = 26
        Width = 121
