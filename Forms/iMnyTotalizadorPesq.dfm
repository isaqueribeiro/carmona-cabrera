object FrmTotalizadorPesq: TFrmTotalizadorPesq
  Left = 375
  Top = 109
  Width = 661
  Height = 451
  BorderIcons = [biSystemMenu]
  Caption = 'Cadastro de Totalizador'
  Color = clBtnFace
  ...
  object PgCtrlMain: TcxPageControl
    ...
    object TbShtPrincipal: TcxTabSheet
      ...
      object GrpBxPesquisa: TcxGroupBox
        Left = 2
        Top = 8
        Caption = 'Pesquise o Totalizador'
      ...
      object DbGrd: TcxGrid
        ...
        object DbGridDBTblVw: TcxGridDBTableView
          ...
          object DbGridDBTblVwtot_nome: TcxGridDBColumn
            Caption = 'Nome'
            DataBinding.FieldName = 'tot_nome'
          end
          object DbGridDBTblVwtot_ordem: TcxGridDBColumn
            Caption = 'Ordem'
            DataBinding.FieldName = 'tot_ordem'
          end
        end
  ...
  object QryMaster: TSQLQuery
    ...
    object QryMastertot_nome: TStringField
      FieldName = 'tot_nome'
      Size = 60
    end
    object QryMastertot_ordem: TSmallintField
      FieldName = 'tot_ordem'
    end
    object QryMastertot_inc: TStringField
      FieldName = 'tot_inc'
      Size = 60
    end
    object QryMastertot_alt: TStringField
      FieldName = 'tot_alt'
      Size = 60
    end
  end
  ...
  object ClntDtStMaster: TClientDataSet
    ...
    object ClntDtStMastertot_nome: TStringField
      FieldName = 'tot_nome'
      Size = 60
    end
    object ClntDtStMastertot_ordem: TSmallintField
      FieldName = 'tot_ordem'
    end
    object ClntDtStMastertot_inc: TStringField
      FieldName = 'tot_inc'
      Size = 60
    end
    object ClntDtStMastertot_alt: TStringField
      FieldName = 'tot_alt'
      Size = 60
    end
  end
  object QryMax: TSQLQuery
    ...
    SQL.Strings = (
      'select'
      '  MAX(coalesce(a.`tot_codigo`,0)) as seq'
      'from'
      '  `mny_totalizador` a')
    SQLConnection = FrmLogin.conWebMaster
    Left = 368
