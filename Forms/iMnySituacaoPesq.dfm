object FrmSituacaoPesq: TFrmSituacaoPesq
  Left = 375
  Top = 109
  Width = 661
  Height = 451
  ...
  object PgCtrlMain: TcxPageControl
    ...
    object TbShtPrincipal: TcxTabSheet
      ...
      object GrpBxPesquisa: TcxGroupBox
        Left = 2
        Top = 8
        Caption = 'Pesquise a Situa'#231#227'o'
      ...
      object DbGrd: TcxGrid
        ...
        object DbGridDBTblVw: TcxGridDBTableView
          ...
          object DbGridDBTblVwsit_nome: TcxGridDBColumn
  ...
  object QryMaster: TSQLQuery
    ...
    object QryMastersit_inc: TStringField
      FieldName = 'sit_inc'
      Size = 60
    end
    object QryMastersit_alt: TStringField
      FieldName = 'sit_alt'
      Size = 60
    end
  end
  ...
  object ClntDtStMaster: TClientDataSet
    ...
    object ClntDtStMastersit_inc: TStringField
      FieldName = 'sit_inc'
      Size = 60
    end
    object ClntDtStMastersit_alt: TStringField
      FieldName = 'sit_alt'
      Size = 60
    end
  end
  object QryMax: TSQLQuery
    ...
    SQL.Strings = (
      'select'
      '  MAX(coalesce(a.`sit_codigo`,0)) as seq'
      'from'
      '  `sys_situacao` a')
    SQLConnection = FrmLogin.conWebMaster
    Left = 368
