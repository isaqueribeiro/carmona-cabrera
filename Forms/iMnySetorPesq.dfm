object FrmSetorPesq: TFrmSetorPesq
  Left = 375
  Top = 109
  Width = 661
  Height = 451
    ...
    object TbShtPrincipal: TcxTabSheet
      ...
      object DbGrd: TcxGrid
        ...
        object DbGridDBTblVw: TcxGridDBTableView
          ...
          object DbGridDBTblVwset_codigo: TcxGridDBColumn
            Caption = 'C'#243'digo'
          ...
          object DbGridDBTblVwset_gerente: TcxGridDBColumn
            Caption = 'Gerente'
  ...
  object QryMaster: TSQLQuery
    ...
    object QryMasterset_gerente: TStringField
      FieldName = 'set_gerente'
      Size = 60
    end
    object QryMasterset_inc: TStringField
      FieldName = 'set_inc'
      Size = 60
    end
    object QryMasterset_alt: TStringField
      FieldName = 'set_alt'
      Size = 60
    end
  end
  ...
  object ClntDtStMaster: TClientDataSet
    ...
    object ClntDtStMasterset_gerente: TStringField
      FieldName = 'set_gerente'
      Size = 60
    end
    object ClntDtStMasterset_inc: TStringField
      FieldName = 'set_inc'
      Size = 60
    end
    object ClntDtStMasterset_alt: TStringField
      FieldName = 'set_alt'
      Size = 60
    end
  end
  object QryMax: TSQLQuery
    ...
    SQL.Strings = (
      'select'
      '  MAX(coalesce(a.`set_codigo`,0)) as seq'
      'from'
      '  `mny_setor` a')
    SQLConnection = FrmLogin.conWebMaster
    Left = 368
