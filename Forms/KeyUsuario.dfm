  ...
  object PgCtrlMain: TcxPageControl
    ...
    object TbShtPrincipal: TcxTabSheet
      ...
      object DbEdtCodigo: TcxDBTextEdit
        Left = 64
        Top = 16
        DataBinding.DataField = 'usr_codigo'
        DataBinding.DataSource = FrmUsuarioPesq.DtSMaster
        Style.Color = 8454143
        TabOrder = 0
        Width = 121
      end
      object DbEdtNome: TcxDBTextEdit
        Left = 64
        Top = 40
        DataBinding.DataField = 'usr_nome'
        DataBinding.DataSource = FrmUsuarioPesq.DtSMaster
        TabOrder = 1
        Width = 249
      end
      ...
      object DbCmbBxNivel: TcxDBImageComboBox
        Left = 64
        Top = 64
        DataBinding.DataField = 'usr_nivel'
        DataBinding.DataSource = FrmUsuarioPesq.DtSMaster
        Properties.Items = <
          item
      ...
      object DbCmbBxStatus: TcxDBImageComboBox
        Left = 64
        Top = 88
        DataBinding.DataField = 'usr_status'
        DataBinding.DataSource = FrmUsuarioPesq.DtSMaster
        Properties.Items = <
          item
            Description = 'Ativo'
