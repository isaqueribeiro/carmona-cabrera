object FrmCorrentePesq: TFrmCorrentePesq
  Left = 374
  Top = 109
  Width = 795
  Height = 451
    ...
    object TbShtPrincipal: TcxTabSheet
      ...
      object DbGrd: TcxGrid
        ...
        object DbGridDBTblVw: TcxGridDBTableView
          ...
          object DbGridDBTblVwccr_agencia: TcxGridDBColumn
            Caption = 'Agencia'
            DataBinding.FieldName = 'ccr_agencia'
            Width = 80
          end
          object DbGridDBTblVwccr_agencia_dv: TcxGridDBColumn
            Caption = 'DV'
            DataBinding.FieldName = 'ccr_agencia_dv'
            Width = 36
          end
          object DbGridDBTblVwccr_conta: TcxGridDBColumn
            Caption = 'Conta'
            DataBinding.FieldName = 'ccr_conta'
            Width = 116
          end
          object DbGridDBTblVwccr_conta_dv: TcxGridDBColumn
            Caption = 'DV'
            DataBinding.FieldName = 'ccr_conta_dv'
            Width = 39
          end
          object DbGridDBTblVwccr_tipo: TcxGridDBColumn
            Caption = 'Tipo'
            DataBinding.FieldName = 'ccr_tipo'
          ...
          object DbGridDBTblVwban_codigo: TcxGridDBColumn
            Caption = 'Banco'
            DataBinding.FieldName = 'ban_codigo'
            PropertiesClassName = 'TcxLookupComboBoxProperties'
            Properties.KeyFieldNames = 'bco_codigo'
            ...
            Properties.ListSource = DtSBanco
            Width = 192
          end
          object DbGridDBTblVwccr_caixa: TcxGridDBColumn
            Caption = 'Conta Caixa?'
            DataBinding.FieldName = 'ccr_caixa'
            PropertiesClassName = 'TcxImageComboBoxProperties'
            Properties.Items = <
              item
                Description = 'N'#227'o'
  ...
  object QryMaster: TSQLQuery
    ...
    object QryMasterccr_agencia: TStringField
      FieldName = 'ccr_agencia'
      Size = 10
    end
    object QryMasterccr_agencia_dv: TStringField
      FieldName = 'ccr_agencia_dv'
      Size = 3
    end
    object QryMasterccr_conta: TStringField
      FieldName = 'ccr_conta'
      Size = 10
    end
    object QryMasterccr_conta_dv: TStringField
      FieldName = 'ccr_conta_dv'
      Size = 3
    end
    object QryMasterccr_tipo: TSmallintField
      FieldName = 'ccr_tipo'
    end
    object QryMasterban_codigo: TSmallintField
      FieldName = 'ban_codigo'
    end
    object QryMasterccr_inc: TStringField
      FieldName = 'ccr_inc'
      Size = 60
    end
    object QryMasterccr_alt: TStringField
      FieldName = 'ccr_alt'
      Size = 60
    end
    object QryMasterccr_caixa: TSmallintField
      FieldName = 'ccr_caixa'
    end
  end
  ...
  object ClntDtStMaster: TClientDataSet
    ...
    object ClntDtStMasterccr_agencia: TStringField
      FieldName = 'ccr_agencia'
      Size = 10
    end
    object ClntDtStMasterccr_agencia_dv: TStringField
      FieldName = 'ccr_agencia_dv'
      Size = 3
    end
    object ClntDtStMasterccr_conta: TStringField
      FieldName = 'ccr_conta'
      Size = 10
    end
    object ClntDtStMasterccr_conta_dv: TStringField
      FieldName = 'ccr_conta_dv'
      Size = 3
    end
    object ClntDtStMasterccr_tipo: TSmallintField
      FieldName = 'ccr_tipo'
    end
    object ClntDtStMasterban_codigo: TSmallintField
      FieldName = 'ban_codigo'
    end
    object ClntDtStMasterccr_inc: TStringField
      FieldName = 'ccr_inc'
      Size = 60
    end
    object ClntDtStMasterccr_alt: TStringField
      FieldName = 'ccr_alt'
      Size = 60
    end
    object ClntDtStMasterccr_caixa: TSmallintField
      FieldName = 'ccr_caixa'
    end
  end
  object QryMax: TSQLQuery
    ...
    SQL.Strings = (
      'select'
      '  MAX(coalesce(a.`ccr_codigo`,0)) as seq'
      'from'
      '  `mny_conta_corrente` a')
    SQLConnection = FrmLogin.conWebMaster
    Left = 368
  ...
  object QryBanco: TSQLQuery
    ...
    Left = 432
    Top = 240
    object QryBancobco_codigo: TSmallintField
      FieldName = 'bco_codigo'
      Required = True
    end
    object QryBancobco_nome: TStringField
      FieldName = 'bco_nome'
      Size = 60
    end
  end
