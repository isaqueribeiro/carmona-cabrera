object FrmUsuarioPesq: TFrmUsuarioPesq
  Left = 375
  Top = 109
  Width = 661
  Height = 451
  ...
  object QryMaster: TSQLQuery
    ...
    SQL.Strings = (
      ...
      '  `sys_usuario` a'
      'where'
      '  upper(a.`usr_nome`) like upper(:nome)')
    ...
    object QryMasterusr_nivel: TSmallintField
      FieldName = 'usr_nivel'
    end
    object QryMasterusr_senha: TStringField
      FieldName = 'usr_senha'
      Size = 60
    end
    object QryMasterusr_inc: TStringField
      FieldName = 'usr_inc'
      Size = 60
    end
    object QryMasterusr_alt: TStringField
      FieldName = 'usr_alt'
      Size = 60
    end
    object QryMasterusr_status: TSmallintField
  ...
  object ClntDtStMaster: TClientDataSet
    ...
    object ClntDtStMasterusr_nivel: TSmallintField
      FieldName = 'usr_nivel'
    end
    object ClntDtStMasterusr_senha: TStringField
      FieldName = 'usr_senha'
      Size = 60
    end
    object ClntDtStMasterusr_inc: TStringField
      FieldName = 'usr_inc'
      Size = 60
    end
    object ClntDtStMasterusr_alt: TStringField
      FieldName = 'usr_alt'
      Size = 60
    end
    object ClntDtStMasterusr_status: TSmallintField
      FieldName = 'usr_status'
    end
  end
  object QryMax: TSQLQuery
    ...
    SQL.Strings = (
      'select'
      '  MAX(coalesce(a.`usr_codigo`,0)) as seq'
      'from'
      '  `sys_usuario` a')
    SQLConnection = FrmLogin.conWebMaster
    Left = 368
