object FrmCompetencia: TFrmCompetencia
  ...
  Caption = 'Cadastro de Compet'#234'ncias'
  Color = clBtnFace
    ...
    object TbShtPrincipal: TcxTabSheet
      ...
      object DbGrd: TcxGrid
        ...
        object DbGridDBTblVw: TcxGridDBTableView
          ...
          object DbGridDBTblVwcom_codigo: TcxGridDBColumn
            Caption = 'C'#243'digo'
            DataBinding.FieldName = 'com_codigo'
            Width = 72
          end
          object DbGridDBTblVwcom_nome: TcxGridDBColumn
            Caption = 'Descri'#231#227'o'
            DataBinding.FieldName = 'com_nome'
            Width = 313
          end
          object DbGridDBTblVwcom_ano_mes: TcxGridDBColumn
            Caption = 'Ano/M'#234's'
            DataBinding.FieldName = 'com_ano_mes'
            Width = 148
          end
          object DbGridDBTblVwsit_codigo: TcxGridDBColumn
  ...
  object QryMaster: TSQLQuery
    ...
    object QryMastercom_nome: TStringField
      FieldName = 'com_nome'
      Size = 60
    end
    object QryMastercom_ano_mes: TSmallintField
      FieldName = 'com_ano_mes'
    end
    object QryMastersit_codigo: TSmallintField
      FieldName = 'sit_codigo'
    end
    object QryMastercom_inc: TStringField
      FieldName = 'com_inc'
      Size = 60
    end
    object QryMastercom_alt: TStringField
      FieldName = 'com_alt'
      Size = 60
    end
  end
  ...
  object ClntDtStMaster: TClientDataSet
    ...
    object ClntDtStMastercom_nome: TStringField
      FieldName = 'com_nome'
      Size = 60
    end
    object ClntDtStMastercom_ano_mes: TSmallintField
      FieldName = 'com_ano_mes'
    end
    object ClntDtStMastersit_codigo: TSmallintField
      FieldName = 'sit_codigo'
    end
    object ClntDtStMastercom_inc: TStringField
      FieldName = 'com_inc'
      Size = 60
    end
    object ClntDtStMastercom_alt: TStringField
      FieldName = 'com_alt'
      Size = 60
    end
  end
  object QryMax: TSQLQuery
    ...
    SQL.Strings = (
      'select'
      '  MAX(coalesce(a.`com_codigo`,0)) as seq'
      'from'
      '  `sys_competencia` a')
    SQLConnection = FrmLogin.conWebMaster
    Left = 368
