object FrmFormaPesq: TFrmFormaPesq
  Left = 495
  Top = 211
  Width = 661
  Height = 451
    ...
    object TbShtPrincipal: TcxTabSheet
      ...
      object DbGrd: TcxGrid
        ...
        object DbGridDBTblVw: TcxGridDBTableView
          ...
          object DbGridDBTblVwfpg_nome: TcxGridDBColumn
            Caption = 'Nome'
  ...
  object QryMaster: TSQLQuery
    ...
    SQL.Strings = (
      ...
      '  `mny_forma_pagto` a'
      'where'
      '  a.`fpg_nome` like :nome')
    SQLConnection = FrmLogin.conWebMaster
    Left = 336
    Top = 240
    object QryMasterfpg_codigo: TSmallintField
    ...
    object QryMasterfpg_inc: TStringField
      FieldName = 'fpg_inc'
      Size = 60
    end
    object QryMasterfpg_alt: TStringField
      FieldName = 'fpg_alt'
      Size = 60
    end
  end
  ...
  object ClntDtStMaster: TClientDataSet
    ...
    Left = 336
    Top = 272
    object ClntDtStMasterfpg_codigo: TSmallintField
      FieldName = 'fpg_codigo'
      Required = True
    end
    ...
    object ClntDtStMasterfpg_inc: TStringField
      FieldName = 'fpg_inc'
      Size = 60
    end
    object ClntDtStMasterfpg_alt: TStringField
      FieldName = 'fpg_alt'
      Size = 60
    end
  end
  object QryMax: TSQLQuery
    ...
    SQL.Strings = (
      'select'
      '  MAX(coalesce(a.`fpg_codigo`,0)) as seq'
      'from'
      '  `mny_forma_pagto` a')
    SQLConnection = FrmLogin.conWebMaster
    Left = 368
