object FrmPessoaPesq: TFrmPessoaPesq
  Left = 374
  Top = 109
  Width = 661
  Height = 451
    ...
    object TbShtPrincipal: TcxTabSheet
      ...
      object DbGrd: TcxGrid
        ...
        object DbGridDBTblVw: TcxGridDBTableView
          ...
          object DbGridDBTblVwpes_codigo: TcxGridDBColumn
            Caption = 'C'#243'digo'
          ...
          object DbGridDBTblVwpes_documento: TcxGridDBColumn
            Caption = 'CNPJ/CPF'
          ...
          object DbGridDBTblVwpes_status: TcxGridDBColumn
            Caption = 'Status'
  ...
  object QryMaster: TSQLQuery
    ...
    object QryMasterpes_documento: TStringField
    ...
    object QryMasterpes_insc_municipal: TStringField
      FieldName = 'pes_insc_municipal'
    end
    object QryMasterpes_insc_estadual: TStringField
      FieldName = 'pes_insc_estadual'
    end
    object QryMasterpes_contato: TStringField
      FieldName = 'pes_contato'
    end
    object QryMasterpes_fones: TStringField
      FieldName = 'pes_fones'
      Size = 60
    end
    object QryMasterpes_end_logra: TStringField
      FieldName = 'pes_end_logra'
      Size = 60
    end
    object QryMasterpes_end_cidade: TStringField
      FieldName = 'pes_end_cidade'
      Size = 60
    end
    object QryMasterpes_end_bairro: TStringField
      FieldName = 'pes_end_bairro'
      Size = 60
    end
    object QryMasterpes_end_cep: TStringField
      FieldName = 'pes_end_cep'
      Size = 8
    end
    object QryMasterpes_end_uf: TStringField
      FieldName = 'pes_end_uf'
      Size = 2
    end
    object QryMasterpes_obs: TStringField
      FieldName = 'pes_obs'
      Size = 300
    end
    object QryMasterpes_email: TStringField
      FieldName = 'pes_email'
      Size = 60
    end
    object QryMasterccr_codigo: TSmallintField
      FieldName = 'ccr_codigo'
    end
    object QryMasterpes_inc: TStringField
      FieldName = 'pes_inc'
      Size = 60
    end
    object QryMasterpes_alt: TStringField
      FieldName = 'pes_alt'
      Size = 60
    end
    object QryMasterpes_status: TSmallintField
  ...
  object ClntDtStMaster: TClientDataSet
    ...
    object ClntDtStMasterpes_documento: TStringField
      FieldName = 'pes_documento'
    end
    ...
    object ClntDtStMasterpes_nome_fantasia: TStringField
      FieldName = 'pes_nome_fantasia'
      OnChange = ClntDtStMasterpes_nome_fantasiaChange
      Size = 100
    end
    object ClntDtStMasterpes_insc_municipal: TStringField
      FieldName = 'pes_insc_municipal'
    end
    object ClntDtStMasterpes_insc_estadual: TStringField
      FieldName = 'pes_insc_estadual'
    end
    object ClntDtStMasterpes_contato: TStringField
      FieldName = 'pes_contato'
    end
    object ClntDtStMasterpes_fones: TStringField
      FieldName = 'pes_fones'
      Size = 60
    end
    object ClntDtStMasterpes_end_logra: TStringField
      FieldName = 'pes_end_logra'
      Size = 60
    end
    object ClntDtStMasterpes_end_cidade: TStringField
      FieldName = 'pes_end_cidade'
      Size = 60
    end
    object ClntDtStMasterpes_end_bairro: TStringField
      FieldName = 'pes_end_bairro'
      Size = 60
    end
    object ClntDtStMasterpes_end_cep: TStringField
      FieldName = 'pes_end_cep'
      Size = 8
    end
    object ClntDtStMasterpes_end_uf: TStringField
      FieldName = 'pes_end_uf'
      Size = 2
    end
    object ClntDtStMasterpes_obs: TStringField
      FieldName = 'pes_obs'
      Size = 300
    end
    object ClntDtStMasterpes_email: TStringField
      FieldName = 'pes_email'
      Size = 60
    end
    object ClntDtStMasterccr_codigo: TSmallintField
      FieldName = 'ccr_codigo'
    end
    object ClntDtStMasterpes_inc: TStringField
      FieldName = 'pes_inc'
      Size = 60
    end
    object ClntDtStMasterpes_alt: TStringField
      FieldName = 'pes_alt'
      Size = 60
    end
    object ClntDtStMasterpes_status: TSmallintField
      FieldName = 'pes_status'
    end
  end
