...
COMMENT='InnoDB free: 5120 kB; (`tot_codigo`) REFER `tkce/mny_totalizador`(`tot_codigo`)';
...
AVG_ROW_LENGTH=4096 CHARACTER SET 'utf8' COLLATE 'utf8_general_ci'
COMMENT='InnoDB free: 5120 kB; (`orc_codigo`) REFER `tkce/mny_orcamento`(`orc_codigo`)';
...
AVG_ROW_LENGTH=8192 CHARACTER SET 'utf8' COLLATE 'utf8_general_ci'
COMMENT='InnoDB free: 5120 kB; (`ban_codigo`) REFER `tkce/sys_banco`(`bco_codigo`)';
...
CREATE TABLE `mny_movimento` (
  ...
  `mov_tipo` SMALLINT(6) DEFAULT NULL,
...
AVG_ROW_LENGTH=3276 CHARACTER SET 'utf8' COLLATE 'utf8_general_ci'
COMMENT='InnoDB free: 5120 kB; (`cus_codigo`) REFER `tkce/mny_custo`(`cus_codigo`) ON DEL';
...
CHARACTER SET 'utf8' COLLATE 'utf8_general_ci'
COMMENT='InnoDB free: 5120 kB; (`ent_mov_codigo`) REFER `tkce/mny_movimento`(`mov_codigo`';
...
CHARACTER SET 'utf8' COLLATE 'utf8_general_ci'
COMMENT='InnoDB free: 5120 kB; (`dup_mov_codigo` `dup_mov_item`) REFER `tkce/mny_moviment';
...
COMMENT='InnoDB free: 5120 kB; (`sgp_grupo`) REFER `tkce/str_material_grupo`(`grp_codigo`';
...
AVG_ROW_LENGTH=4096 CHARACTER SET 'utf8' COLLATE 'utf8_general_ci'
COMMENT='InnoDB free: 5120 kB; (`mat_apresentacao`) REFER `tkce/str_material_apresentacao';
...
CHARACTER SET 'utf8' COLLATE 'utf8_general_ci'
COMMENT='InnoDB free: 5120 kB; (`ent_ano` `ent_codigo`) REFER `tkce/str_entrada`(`ent_ano';
...
AVG_ROW_LENGTH=16384 CHARACTER SET 'utf8' COLLATE 'utf8_general_ci'
COMMENT='InnoDB free: 5120 kB; (`eaj_competencia`) REFER `tkce/sys_competencia`(`com_codi';
...
AVG_ROW_LENGTH=8192 CHARACTER SET 'utf8' COLLATE 'utf8_general_ci'
COMMENT='InnoDB free: 5120 kB; (`eaj_ano` `eaj_codigo`) REFER `tkce/str_estoque_ajuste`(`';
...
AVG_ROW_LENGTH=8192 CHARACTER SET 'utf8' COLLATE 'utf8_general_ci'
COMMENT='InnoDB free: 5120 kB; (`met_material`) REFER `tkce/str_material`(`mat_codigo`); ';
...
AVG_ROW_LENGTH=2340 CHARACTER SET 'utf8' COLLATE 'utf8_general_ci'
COMMENT='InnoDB free: 5120 kB; (`his_material`) REFER `tkce/str_material`(`mat_codigo`) O';
...
COMMENT='InnoDB free: 5120 kB; (`mat_codigo`) REFER `tkce/str_material`(`mat_codigo`) ON ';
...
AVG_ROW_LENGTH=8192 CHARACTER SET 'utf8' COLLATE 'utf8_general_ci'
COMMENT='InnoDB free: 5120 kB; (`usr_codigo`) REFER `tkce/sys_usuario`(`usr_codigo`) ON D';
...
AVG_ROW_LENGTH=16384 CHARACTER SET 'utf8' COLLATE 'utf8_general_ci'
COMMENT='InnoDB free: 5120 kB; (`obj_codigo`) REFER `tkce/sys_objeto`(`obj_codigo`) ON UP';
