object FrmPessoa: TFrmPessoa
  ...
  object PgCtrlMain: TcxPageControl
    ...
    object TbShtPrincipal: TcxTabSheet
      ...
      object DbEdtCodigo: TcxDBTextEdit
        ...
        DataBinding.DataSource = FrmPessoaPesq.DtSMaster
        Style.Color = 8454143
        TabOrder = 0
        Width = 89
      end
      ...
      object DbEdtCidade: TcxDBTextEdit
        Left = 64
        Top = 136
        DataBinding.DataField = 'pes_end_cidade'
        DataBinding.DataSource = FrmPessoaPesq.DtSMaster
        TabOrder = 9
        Width = 114
      end
      ...
      object DbEdtContato: TcxDBTextEdit
        Left = 64
        Top = 160
      ...
      object DbEdtFones: TcxDBTextEdit
        Left = 384
        Top = 160
      ...
      object LkpCmbBxTipo: TcxDBLookupComboBox
        Left = 200
        Top = 16
      ...
      object LkpCmbBxConta: TcxDBLookupComboBox
        Left = 64
        Top = 232
      ...
      object DbImgCmbBxStatus: TcxDBImageComboBox
        Left = 64
        Top = 256
  ...
  object QryTipo: TSQLQuery
    ...
    Left = 472
    Top = 24
    object QryTipotip_codigo: TSmallintField
      FieldName = 'tip_codigo'
      Required = True
    end
    object QryTipotip_nome: TStringField
      FieldName = 'tip_nome'
      Size = 60
    end
  end
