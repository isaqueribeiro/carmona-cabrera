object FrmUnidadePesq: TFrmUnidadePesq
    ...
    object TbShtPrincipal: TcxTabSheet
      ...
      object DbGrd: TcxGrid
        ...
        object DbGridDBTblVw: TcxGridDBTableView
          ...
          object DbGridDBTblVwuni_codigo: TcxGridDBColumn
            Caption = 'C'#243'digo'
  ...
  object QryMaster: TSQLQuery
    ...
    object QryMasteruni_inc: TStringField
      FieldName = 'uni_inc'
      Size = 60
    end
    object QryMasteruni_alt: TStringField
      FieldName = 'uni_alt'
      Size = 60
    end
  end
  ...
  object ClntDtStMaster: TClientDataSet
    ...
    object ClntDtStMasteruni_inc: TStringField
      FieldName = 'uni_inc'
      Size = 60
    end
    object ClntDtStMasteruni_alt: TStringField
      FieldName = 'uni_alt'
      Size = 60
    end
  end
  object QryMax: TSQLQuery
    ...
    SQL.Strings = (
      'select'
      '  MAX(coalesce(a.`uni_codigo`,0)) as seq'
      'from'
      '  `mny_unidade` a')
    SQLConnection = FrmLogin.conWebMaster
    Left = 368
