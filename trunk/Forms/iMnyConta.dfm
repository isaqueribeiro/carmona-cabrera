object FrmContaPesq: TFrmContaPesq
  Left = 375
  Top = 109
  Width = 661
  Height = 451
  BorderIcons = [biSystemMenu]
  Caption = 'Cadastro de Contas Cont'#225'beis'
  Color = clBtnFace
    ...
    object TbShtPrincipal: TcxTabSheet
      ...
      object DbGrd: TcxGrid
        ...
        object DbGridDBTblVw: TcxGridDBTableView
          ...
          object DbGridDBTblVwcon_codigo: TcxGridDBColumn
            Caption = 'C'#243'digo'
            DataBinding.FieldName = 'con_codigo'
            Width = 81
          end
          ...
          object DbGridDBTblVworc_codigo: TcxGridDBColumn
            ...
            Properties.KeyFieldNames = 'orc_codigo'
  ...
  object QryMaster: TSQLQuery
    ...
    object QryMastercon_inc: TStringField
      FieldName = 'con_inc'
      Size = 60
    end
    object QryMastercon_alt: TStringField
      FieldName = 'con_alt'
      Size = 60
    end
  end
  ...
  object ClntDtStMaster: TClientDataSet
    ...
    object ClntDtStMastercon_inc: TStringField
      FieldName = 'con_inc'
      Size = 60
    end
    object ClntDtStMastercon_alt: TStringField
      FieldName = 'con_alt'
      Size = 60
    end
  end
  object QryMax: TSQLQuery
    ...
    SQL.Strings = (
      'select'
      '  MAX(coalesce(a.`con_codigo`,0)) as seq'
      'from'
      '  `mny_conta` a')
    SQLConnection = FrmLogin.conWebMaster
    Left = 368
  ...
  object QryOrcamento: TSQLQuery
    ...
    Left = 432
    Top = 240
    object QryOrcamentoorc_codigo: TSmallintField
      FieldName = 'orc_codigo'
      Required = True
    end
    object QryOrcamentoorc_nome: TStringField
      FieldName = 'orc_nome'
      Size = 60
    end
  end
