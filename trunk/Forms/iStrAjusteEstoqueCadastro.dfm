inherited FrmAjusteEstoqueCadastro: TFrmAjusteEstoqueCadastro
      ...
      inherited TbsPrincipal: TcxTabSheet
        inherited GrpDadosNominais: TcxGroupBox
          ...
          object dbCodigo: TcxDBTextEdit
            Left = 168
            Top = 24
            DataBinding.DataField = 'eaj_codigo'
          ...
          object dbUnidadeNegocio: TcxDBLookupComboBox
            Left = 360
            Top = 24
            DataBinding.DataField = 'eaj_unidade_neg'
            DataBinding.DataSource = DtsMaster
          ...
          object dbData: TcxDBDateEdit
            Left = 360
            Top = 48
            DataBinding.DataField = 'eaj_data'
            DataBinding.DataSource = DtsMaster
            TabOrder = 8
            Width = 121
          end
          ...
          object dbHora: TcxDBTextEdit
            Left = 528
            Top = 48
            DataBinding.DataField = 'eaj_hora'
            DataBinding.DataSource = DtsMaster
            Properties.ReadOnly = True
            Style.Color = 8454143
            TabOrder = 10
          ...
          object dbUsuarioAbertura: TcxDBTextEdit
            Left = 632
            Top = 48
            DataBinding.DataField = 'eaj_usuario_abertura'
            DataBinding.DataSource = DtsMaster
            Properties.ReadOnly = True
            Style.Color = 8454143
            TabOrder = 12
          ...
          object dbSituacao: TcxDBTextEdit
            Left = 632
            Top = 72
            DataBinding.DataField = 'eaj_status'
            DataBinding.DataSource = DtsMaster
            Properties.ReadOnly = True
            Style.Color = 8454143
            TabOrder = 16
        ...
        object DbgConsulta: TcxGrid
          ...
          ParentFont = False
          TabOrder = 1
          object DbgConsultaDB: TcxGridDBTableView
            ...
            object DbgConsultaDBitm_sequencia: TcxGridDBColumn
              Caption = '#'
            ...
            object DbgConsultaDBitm_material: TcxGridDBColumn
              Caption = 'C'#243'digo'
            ...
            object DbgConsultaDBmat_descricao_resumo: TcxGridDBColumn
              Caption = 'Descri'#231#227'o'
              DataBinding.FieldName = 'mat_descricao_resumo'
              Options.Editing = False
            end
            object DbgConsultaDBitm_qtde_nova: TcxGridDBColumn
              Caption = 'Quant.'
            ...
            object DbgConsultaDBund_descricao: TcxGridDBColumn
              Caption = 'Unidade'
          ...
          object DbgConsultaLvl: TcxGridLevel
            GridView = DbgConsultaDB
          end
        end
        object Pnl: TPanel
          Left = 0
        ...
        object pnlItemControle: TPanel
          ...
          object GrpItemEdit: TcxGroupBox
            ...
            object dbItemQuantidade: TcxDBTextEdit
              Left = 112
              Top = 72
              DataBinding.DataField = 'itm_qtde_nova'
              DataBinding.DataSource = DtsDetail
              TabOrder = 6
              Width = 81
            end
            ...
            object dbItemUnidadeCompra: TcxDBLookupComboBox
              Left = 304
              Top = 72
              DataBinding.DataField = 'itm_unidade_consumo'
              DataBinding.DataSource = DtsDetail
              Properties.DropDownListStyle = lsFixedList
  ...
  inherited CdsMaster: TClientDataSet
    ...
    object CdsMastereaj_status: TSmallintField
      ...
      ProviderFlags = [pfInUpdate]
      OnGetText = CdsMastereaj_statusGetText
    end
  ...
  object QryDetail: TSQLQuery
    ...
    SQL.Strings = (
      ...
      '  , itm.itm_qtde_antiga'
      '  , itm.itm_qtde_nova'
      '  , itm.itm_unidade_consumo'
      '  , itm.itm_fracionador'
      '  , mat.mat_descricao_resumo'
      '  , uns.und_descricao'
      '  , uns.und_sigla'
      'from str_estoque_ajuste_item itm'
      
        '  left join str_material mat on (mat.mat_codigo = itm.itm_materi' +
        'al)'
      
        '  left join str_unidade uns on (uns.und_codigo = itm.itm_unidade' +
        '_consumo) '
      'where itm.eaj_ano    = :eaj_ano'
      '  and itm.eaj_codigo = :eaj_codigo')
    SQLConnection = FrmLogin.conWebMaster
    Left = 16
    Top = 392
  end
  ...
  object CdsDetail: TClientDataSet
    ...
    Left = 80
    Top = 392
    object CdsDetaileaj_ano: TSmallintField
      FieldName = 'eaj_ano'
      ProviderFlags = [pfInUpdate, pfInKey]
      Required = True
    end
    object CdsDetaileaj_codigo: TIntegerField
      FieldName = 'eaj_codigo'
      ProviderFlags = [pfInUpdate, pfInKey]
      Required = True
      DisplayFormat = '00000'
    ...
    object CdsDetailitm_qtde_antiga: TFMTBCDField
      FieldName = 'itm_qtde_antiga'
      ProviderFlags = [pfInUpdate]
      Precision = 20
      Size = 4
    end
    object CdsDetailitm_qtde_nova: TFMTBCDField
      DisplayLabel = 'Quantidade'
      FieldName = 'itm_qtde_nova'
      ProviderFlags = [pfInUpdate]
      Required = True
      Precision = 20
      Size = 4
    end
    object CdsDetailitm_unidade_consumo: TIntegerField
      Alignment = taLeftJustify
      DisplayLabel = 'Unidade de Consumo'
      FieldName = 'itm_unidade_consumo'
      ProviderFlags = [pfInUpdate]
      Required = True
    end
    object CdsDetailitm_fracionador: TFMTBCDField
    ...
    object CdsDetailmat_descricao_resumo: TStringField
      FieldName = 'mat_descricao_resumo'
      ProviderFlags = []
      Size = 100
    end
    object CdsDetailund_descricao: TStringField
      FieldName = 'und_descricao'
      ProviderFlags = []
      Size = 100
    end
    object CdsDetailund_sigla: TStringField
      FieldName = 'und_sigla'
      ProviderFlags = []
      Size = 10
    end
