object FrmNegocioPesq: TFrmNegocioPesq
  Left = 495
  Top = 211
  Width = 661
  Height = 451
  BorderIcons = [biSystemMenu]
  Caption = 'Cadastro Centros de  Neg'#243'cios'
  Color = clBtnFace
  ...
  object PgCtrlMain: TcxPageControl
    ...
    object TbShtPrincipal: TcxTabSheet
      ...
      object LblDados: TLabel
        ...
        Width = 163
        Height = 13
        Caption = 'Dados do Centro de Neg'#243'cios'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindow
        Font.Height = -11
        Font.Name = 'Tahoma'
      ...
      object GrpBxPesquisa: TcxGroupBox
        Left = 2
        Top = 8
        Caption = 'Pesquise o Centro de Neg'#243'cios'
      ...
      object DbGrd: TcxGrid
        ...
        object DbGridDBTblVw: TcxGridDBTableView
          ...
          object DbGridDBTblVwneg_codigo: TcxGridDBColumn
            Caption = 'C'#243'digo'
            DataBinding.FieldName = 'neg_codigo'
          end
  ...
  object QryMaster: TSQLQuery
    ...
    object QryMasterneg_inc: TStringField
      FieldName = 'neg_inc'
    end
    object QryMasterneg_alt: TStringField
      FieldName = 'neg_alt'
    end
  end
  ...
  object ClntDtStMaster: TClientDataSet
    ...
    object ClntDtStMasterneg_inc: TStringField
      FieldName = 'neg_inc'
    end
    object ClntDtStMasterneg_alt: TStringField
      FieldName = 'neg_alt'
    end
  end
  object QryMax: TSQLQuery
    ...
    SQL.Strings = (
      'select'
      '  MAX(coalesce(a.`neg_codigo`,0)) as seq'
      'from'
      '  `mny_centro_negocio` a')
    SQLConnection = FrmLogin.conWebMaster
    Left = 368
