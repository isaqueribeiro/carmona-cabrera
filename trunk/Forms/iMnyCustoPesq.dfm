object FrmCustoPesq: TFrmCustoPesq
  Left = 415
  Top = 123
  Width = 661
  Height = 451
  BorderIcons = [biSystemMenu]
  Caption = 'Cadastro de Tipos de Custo'
  Color = clBtnFace
    ...
    object TbShtPrincipal: TcxTabSheet
      ...
      object DbGrd: TcxGrid
        ...
        object DbGridDBTblVw: TcxGridDBTableView
          ...
          object DbGridDBTblVwcus_codigo: TcxGridDBColumn
            Caption = 'C'#243'digo'
            DataBinding.FieldName = 'cus_codigo'
          end
  ...
  object QryMaster: TSQLQuery
    ...
    object QryMastercus_inc: TStringField
      FieldName = 'cus_inc'
      Size = 60
    end
    object QryMastercus_alt: TStringField
      FieldName = 'cus_alt'
      Size = 60
    end
  end
  ...
  object ClntDtStMaster: TClientDataSet
    ...
    object ClntDtStMastercus_inc: TStringField
      FieldName = 'cus_inc'
      Size = 60
    end
    object ClntDtStMastercus_alt: TStringField
      FieldName = 'cus_alt'
      Size = 60
    end
  end
  object QryMax: TSQLQuery
    ...
    SQL.Strings = (
      'select'
      '  MAX(coalesce(a.`cus_codigo`,0)) as seq'
      'from'
      '  `mny_custo` a')
    SQLConnection = FrmLogin.conWebMaster
    Left = 368
