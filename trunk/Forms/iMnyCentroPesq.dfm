object FrmCentroPesq: TFrmCentroPesq
  Left = 494
  Top = 211
  Width = 661
  Height = 451
  BorderIcons = [biSystemMenu]
  Caption = 'Cadastro Centros de Custos'
  Color = clBtnFace
    ...
    object TbShtPrincipal: TcxTabSheet
      ...
      object DbGrd: TcxGrid
        ...
        object DbGridDBTblVw: TcxGridDBTableView
          ...
          object DbGridDBTblVwcen_codigo: TcxGridDBColumn
            Caption = 'C'#243'digo'
            DataBinding.FieldName = 'cen_codigo'
          end
  ...
  object QryMaster: TSQLQuery
    ...
    object QryMastercen_inc: TStringField
      FieldName = 'cen_inc'
      Size = 60
    end
    object QryMastercen_alt: TStringField
      FieldName = 'cen_alt'
      Size = 60
    end
  end
  ...
  object ClntDtStMaster: TClientDataSet
    ...
    object ClntDtStMastercen_inc: TStringField
      FieldName = 'cen_inc'
      Size = 60
    end
    object ClntDtStMastercen_alt: TStringField
      FieldName = 'cen_alt'
      Size = 60
    end
  end
  object QryMax: TSQLQuery
    ...
    SQL.Strings = (
      'select'
      '  MAX(coalesce(a.`cen_codigo`,0)) as seq'
      'from'
      '  `mny_centro_custo` a')
    SQLConnection = FrmLogin.conWebMaster
    Left = 368
