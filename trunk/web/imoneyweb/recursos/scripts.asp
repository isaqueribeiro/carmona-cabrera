...
//-->
function jS (URL,largura,altura){ 
  ...
  // Abre a nova janela 
  window.open(URL,'','height=' + altura + ', width=' + largura + ', top=' + topo + ', left=' + esquerda + ',scrollbars=yes'); 
