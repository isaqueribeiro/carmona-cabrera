object SM: TSM
  ...
  object SQLConnection: TSQLConnection
    ConnectionName = 'DataSnapContatos'
    DriverName = 'Firebird'
    LoginPrompt = False
    Params.Strings = (
      'DriverName=Firebird'
      ...
      'VendorLibOsx=/Library/Frameworks/Firebird.framework/Firebird'
        ...
        'Database=D:\Projetos\ASS\CarmonaCabrera\test\DataSnap_Contatos\d' +
        'b\DB_CONTADOS.FDB'
      'User_Name=sysdba'
      'Password=masterkey'
      'Role=RoleName'
  ...
  object dtsContatos: TSQLDataSet
    CommandText = 'select * from CONTATOS'#13#10'where nome like :nome'#13#10'order by nome'
    MaxBlobSize = -1
    Params = <
      item
        DataType = ftString
